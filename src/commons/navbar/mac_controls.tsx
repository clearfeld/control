    ...
    return (
        ...
        >
            <button
                ...
                {...stylex.props(styles.button, styles.close_btn)}
            >
            ...
            <button
                ...
                {...stylex.props(styles.button, styles.minimize_btn)}
            >
            ...
            <button
                onClick={async () => {
                    if (isAltKeyPressed) {
                        ...
                        const isFullscreened =
                            await getCurrentWindow().isFullscreen();
                        await getCurrentWindow().setFullscreen(!isFullscreened);
                    }
                }}
                {...stylex.props(styles.button, styles.maximize_btn)}
            >
                {isHovering && (
                    <>
                        {isAltKeyPressed ? (
