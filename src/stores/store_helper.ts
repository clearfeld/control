...
// TODO: delete this file in the future and move all the values to something better (possibly stronghold)

// Create a new store or load the existing one,
// note that the options will be ignored if a `Store` with that path has already been created
export const store = await load("temp_store_keys.json", { autoSave: false });
